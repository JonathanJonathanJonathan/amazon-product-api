...
var formatQueryParams = function (query, method, credentials) {
  ...
  if (method === 'ItemSearch') {
    ...
    // If IgnoreItemPage is set, a ItemPage cannot be specified in the request. Necessary for India Giftcards
    if (params['IgnoreItemPage'] === true) {
      delete params['ItemPage'];
      delete params['IgnoreItemPage'];
    }
